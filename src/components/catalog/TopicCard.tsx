    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        <span className="flex min-w-0 items-center gap-2">
          <span
            aria-hidden
            className="grid h-7 w-7 shrink-0 place-items-center rounded-[8px] border border-white/8 bg-white/4 text-muted transition-colors duration-300 group-hover:border-positive/30 group-hover:text-positive-light"
          >
