...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 px-5 text-center">
      ...
      <h1 className="m-0 font-serif text-[clamp(2.2rem,5vw,3.6rem)] leading-none font-normal tracking-[-0.025em] text-cream-bright">
        No topic <em className="italic">here.</em>
      </h1>
